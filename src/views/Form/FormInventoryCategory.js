...
import { registerInventorycategory, updateInventorycategory } from './../../actions/inventorycategory';
...
const Modals = (props) => {
  ...
  const handleSubmit = (e) =>{
        ...
        if(id && id > 0)
        {
          ...
          props.updateInventorycategory(fd);
        }else{
          fd.append('cat', 'insert');
          props.registerInventorycategory(fd);
        }
  ...
  return (
    <div>
      <Modal isOpen={modal} toggle={toggle} backdrop='static' keyboard={false}>
        <ModalHeader toggle={resetdata}><i className='fa fa-hospital-o'></i> Inventory Categories</ModalHeader>
        <ModalBody>
        <Form>
          <FormGroup row>
          <Col sm={12}>
