...
import { registerMaintenancecategory, updateMaintenancecategory } from './../../actions/maintenancecategory';
...
const Modals = (props) => {
  ...
  const handleSubmit = (e) =>{
        ...
        if(id && id > 0)
        {
          ...
          props.updateMaintenancecategory(fd);
        }else{
          fd.append('cat', 'insert');
          props.registerMaintenancecategory(fd);
        }
